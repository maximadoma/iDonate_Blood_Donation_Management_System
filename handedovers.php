					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$handovers = $conn->query("SELECT hr.*,r.requester_name,r.blood_type, r.quantity,r.ref_code FROM handedover_request hr inner join requests r on r.id = hr.request_id order by date(hr.date_created) desc ");
								...
								<tr>
									...
									<td class="">
										 <p> <b><?php echo ucwords($row['requester_name']) ?></b></p>
									</td>
									<td class="">
										 <p> <b><?php echo $row['blood_type'] ?></b></p>
									</td>
									<td class="">
										 <p>Qty. of Bag(s) Given: <b><?php echo  ($row['quantity']) ?></b></p>
