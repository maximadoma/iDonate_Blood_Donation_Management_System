...
<nav id="sidebar" class='mx-lt-5 bg-light' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=inventory" class="nav-item nav-inventory"><span class='icon-field'><i class="fa-solid fa-boxes-stacked text-danger"></i></span> Inventory</a>
				<a href="index.php?page=donors" class="nav-item nav-donors"><span class='icon-field'><i class="fa fa-user-friends text-danger"></i></span> Registered Donors</a>
