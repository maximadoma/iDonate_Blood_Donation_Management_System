...
if(isset($_GET['id'])){
$qry = $conn->query("SELECT hr.*,r.requester_name,r.blood_type, r.quantity,r.ref_code FROM handedover_request hr inner join requests r on r.id = hr.request_id where hr.id= ".$_GET['id']);
...
<div class="container-fluid">
    <form action="" id="manage-handover">
        ...
        <div class="form-group">
            <label for="" class="control-label">Requester's Reference Code</label>
            ...
            success:function(resp){
                if(resp){
                    ...
                    if(resp.status == 1){
                        ...
                        _html += '<p>ID Number: '+resp.data.id+'<b></b></p>';
                        _html += '<p>Blood Type: '+resp.data.blood_type+'<b></b></p>';
                        _html += '<p>Quantity Needed: '+resp.data.quantityQ+'<b></b></p>';
